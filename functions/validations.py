...
# saved id of last track downloaded
def downloadLog(dirt: str, playListName: str, remaining: str) -> None:
...
# delete bad downloaded files (download not finish)
def removeFileMusic(dirt: str, playlistName: str, nameFile: str, remaining: str) -> None:
