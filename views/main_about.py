...
class About(object):
    ...
    def retranslateUi(self, about):
        ...
        self.label.setText(QCoreApplication.translate("about", u"Python Ver. 3.10.4", None))
        self.label_2.setText(QCoreApplication.translate("about", u"PySide6 Ver. 6.3.0", None))
